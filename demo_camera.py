...
if __name__ == '__main__':
    ...
    for i in [1,2,3,4,6,8]:
        image_list.append('./data/demo/00000{}.jpg'.format(i))

    network = None if args.deploy_net else args.network
    class_names = parse_class_names(args.class_names)
    if args.network == 'mobilenet':
        prefix = os.path.join(os.getcwd(), 'model', 
                'mobilenet-ssd-' + str(args.data_shape))
    elif args.prefix.endswith('_'):
